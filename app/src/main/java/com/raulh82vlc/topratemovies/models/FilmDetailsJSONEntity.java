...
public class FilmDetailsJSONEntity {
    ...
    /**
     * getToString does the output in an appropriated string
     * @param collective
     * @return string of the composed data structures
     */
    ...
    /**
     * getToStringGenres does the output of Genres in an appropriated string
     * @return string of genres
     */
    public String getToStringGenres() {
        int position = 0;
        String str = "";
        if(genres != null) {
            int sizeOfWriters = genres.size();
