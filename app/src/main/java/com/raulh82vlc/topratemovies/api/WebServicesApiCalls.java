...
public class WebServicesApiCalls {
    ...
    {
        mApiFilmInterface.getFilmsTop(ApiConstans.TOKEN, ApiConstans.formatToRetrofit, fromFirst, toLast, ApiConstans.formatOfInfo, oFilms);
    }
    ...
    {
        mApiFilmInterface.getFilmsByName(ApiConstans.TOKEN, ApiConstans.formatToRetrofit, iMovieTitle, oFilm);
    }
